package com.birendra.lensdayshop.ui
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        mMap = googleMap
        val clientLocation2 = LatLng(27.3232, 32.323)
        mMap.addMarker(MarkerOptions().position(clientLocation2).title("Softwarica"))
        val clientLocation3 = LatLng(27.3232, 32.323)
        mMap.addMarker(MarkerOptions().position(clientLocation3).title("Softwarica"))
        val clientLocation4 = LatLng(27.3232, 32.323)
        mMap.addMarker(MarkerOptions().position(clientLocation4).title("Softwarica"))
    }
